...
metadata["results"] = {
    ...
    "uncorrected energy": {
        "calculation": ["bsse"],
        "description": "The total energy before the counterpoise correction",
        "dimensionality": "scalar",
        "property": "uncorrected energy#Psi4#{model}",
        "type": "float",
        "units": "E_h",
        "format": ".8f",
    },
    "bsse correction": {
        "calculation": ["bsse"],
        "description": "The counterpoise (BSSE) correction",
        "dimensionality": "scalar",
        "property": "BSSE correction#Psi4#{model}",
        "type": "float",
        "units": "E_h",
        "format": ".8f",
    },
    "interaction energy": {
        "calculation": ["bsse"],
        "description": "The counterpoise-corrected interaction energy",
        "dimensionality": "scalar",
        "property": "interaction energy#Psi4#{model}",
        "type": "float",
        "units": "kJ/mol",
        "format": ".4f",
    },
    "uncorrected interaction energy": {
        "calculation": ["bsse"],
        "description": "The uncorrected interaction energy",
        "dimensionality": "scalar",
        "property": "uncorrected interaction energy#Psi4#{model}",
        "type": "float",
        "units": "kJ/mol",
        "format": ".4f",
    },
